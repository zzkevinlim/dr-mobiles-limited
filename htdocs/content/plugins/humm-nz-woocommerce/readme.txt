=== Humm Payment Gateway for WooCommerce ===
Tags: humm
Stable tag: trunk
...
Input dynamic hooks in the admin console field "Hook On Product Page", then click button 'save changes' on the bottom
...
tech support email: Roger.bi@humm-group.com
