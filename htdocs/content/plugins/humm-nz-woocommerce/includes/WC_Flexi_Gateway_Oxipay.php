...
abstract class WC_Flexi_Gateway_Oxipay extends WC_Payment_Gateway
{
    ...
    function __construct($config)
    {
        ...
        if ($this->settings['enabled'] == 'yes' && isset($this->settings['page_builder']) && $this->settings['page_builder'] == 'yes') {
    ...
    function init_form_fields()
    {
        ...
        $this->form_fields = array(
            'enabled' => array(
                ...
                'default' => 'yes',
                'description' => ' <font color = "#FF00FF">Please learn <a href ="https://github.com/shophumm/humm-nz-woocommerce/blob/master/readme.txt/" target="_blank"> Version Change Logs and Instructions</a></font>',
                'desc_tip' => false
            ),
            ...
            $this->pluginFileName . '_api_key' => array(
                ...
                'type' => 'text',
                'default' => '',
                'description' => $this->pluginDisplayName . ' will have supplied you with your ' . $this->pluginDisplayName . ' API key. <font color = "#FF00FF">if 401 error happens during redirecting to Humm,please check API key </font>',
                'desc_tip' => false,
                'custom_attributes' => array('required' => 'required'),
            ),
            ...
            'hook_widget_selector' => array(
                'title' => __('Hook On Product Page', 'woocommerce'),
                'type' => 'text',
                'default' => 'woocommerce_single_product_summary',
                'description' => '<i><p>a WooCommerce Hook on product page for widget showing position,ex woocommerce_single_product_summary</p> <p>
                woocommerce_after_add_to_cart_form,woocommerce_after_single_product_summary and woocommerce_before_add_to_cart_button, do not change if unsure</p></i>'
            ),
            ...
            'price_widget_advanced' => array(
                ...
                'default' => 'no',
                'description' => '<font color = "#FF00FF">beta functions</font>,Leave disabled if unsure',
            ),
            ...
            'use_modal' => array(
                ...
                'default' => 'no',
                'description' => __('The customer will be forwarded to checkout in a modal dialog <font color = "red">deprecated function<font> ', 'woocommerce')
            ),
            'shop_settings' => array(
            ...
            'force_humm' => array(
                ...
                'default' => 'yes',
                'description' => __('You will switch to <strong>humm</strong> if this is set to \'yes\'. Otherwise you will be automatically switched over on the official humm launch date, <font color = "red">deprecated function<font>', 'woocommerce'),
                'desc_tip' => false
            ),
            ...
            $this->pluginFileName . '_maximum' => array(
                ...
                'type' => 'text',
                'default' => '0',
                'description' => 'Maximum order total to use ' . $this->pluginDisplayName . '. leave Empty for $100000,<p><i> above and beyond value causes no widget show and blocks checkout</p></i>',
                'desc_tip' => false,
            ),
            $this->pluginFileName . '_thresholdAmount' => array(
                ...
                'type' => 'text',
                'default' => '2000',
                'description' => 'Little Things Threshold Amount to use ' . $this->pluginDisplayName . '. <font color = "red">deprecated function<font>',
                'desc_tip' => false,
            ),
        );
    }
